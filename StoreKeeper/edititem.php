			...
			<table class="table">
				<?php
					...
					<tr>
						...
						<td><input type="text" class="form-control" id="itemId" value="$id" name="itemId" readonly></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="form-control" id="instock" name="instock" value="$instock"></td>
					</tr>
					<tr>
					...
					<tr>
						<td><a href="index.php"><u>Exit Editing</u></a></td>
					</tr>
_END;
			  	?>
				</tbody>
...
<?php
	if ( isset( $_POST['itemId'] ) ){
		...
		$price = sanitizeString ( $_POST['price'] );
 		...
 		$item = array ( $id, $name, $price, $instock );
		editItem ( $item );
